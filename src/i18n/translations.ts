export const translations = {
  de: {
    ...
    hero: {
      title1: 'Simple Automatisierung',
      title2: 'Produktivität',
      title2Accent: 'Enorme',
      subtitle: 'Einfachheit trifft auf Leistung',
      badges: ['No-Code Lösungen', 'DSGVO-Konform', 'On-Premise Hosting', 'Enterprise Ready'],
      cta: {
    ...
    businessApp: {
      ...
      features: {
        ...
        workflow: {
          ...
          description: 'Verwalten und überwachen Sie Ihre Automatisierungen',
          highlights: ['Workflow-Status', 'Ausführungshistorie', 'Live-Updates']
        },
        support: {
          title: 'Support & Hilfe',
          description: 'Umfassende Unterstützung für Ihren Erfolg',
          highlights: ['24/7 Support', 'Dokumentation', 'Community Forum']
        }
      },
      cta: 'Demo anfordern'
    },
    ...
    footer: {
      ...
      team: {
        roles: {
          cto: 'CTO & Lead Developer',
          ctoDesc: 'Full-Stack Automation',
          cfo: 'CFO',
          cfoDesc: 'Finanz & Buchhaltung',
          coo: 'COO & Operations',
  ...
  en: {
    ...
    hero: {
      title1: 'Seamless Automation',
      title2: 'Limitless',
      title2Accent: 'Productivity',
      subtitle: 'Simplicity Meets Power',
      badges: ['No-Code Solutions', 'GDPR Compliant', 'On-Premise Hosting', 'Enterprise Ready'],
      cta: {
    ...
    businessApp: {
      ...
      features: {
        ...
        workflow: {
          title: 'Workflow Management',
          description: 'Manage and monitor your automations',
          highlights: ['Workflow Status', 'Execution History', 'Live Updates']
        },
        support: {
          title: 'Support & Help',
          description: 'Comprehensive support for your success',
          highlights: ['24/7 Support', 'Documentation', 'Community Forum']
        }
      },
      cta: 'Request Demo'
    },
    ...
    footer: {
      ...
      copyright: '© 2025 AutoProd. All rights reserved.',
      legal: {
        imprint: 'Imprint',
        privacy: 'Privacy',
        terms: 'Terms'
