  ...
  return (
    <div className="lg:col-span-2 mb-4 lg:mb-0">
      <div className="h-full p-4 sm:p-6 lg:p-8 rounded-2xl bg-[#1A1A1A] border border-white/10">
        <div className={`transition-all duration-500 ease-out ${isTransitioning ? 'opacity-0 translate-y-2' : 'opacity-100 translate-y-0'}`}>
        ...
        <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-5 mb-5 sm:mb-8 lg:mb-10">
          ...
          <div className="flex-1">
            <h3 className="text-2xl sm:text-3xl lg:text-3xl font-black text-white mb-2 sm:mb-3 lg:mb-4">{displayedService.title}</h3>
            <p className="text-white/80 text-sm sm:text-base lg:text-lg leading-snug sm:leading-relaxed">{displayedService.description}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 gap-3 sm:gap-6 lg:gap-8">
          <div className="bg-white/5 rounded-xl p-3 sm:p-5 lg:p-6">
            ...
            <ul className="space-y-2.5 sm:space-y-4">
              {displayedService.features.map((feature, idx) => (
          ...
          <div className="bg-white/5 rounded-xl p-3 sm:p-5 lg:p-6">
            ...
            <ul className="space-y-2.5 sm:space-y-4">
              {displayedService.examples.map((example, idx) => (
                <li key={idx} className="flex items-start gap-2 sm:gap-3">
